...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python3 fishSizeEstimation.py train --dataset=/path/to/balloon/dataset --weights=coco

    # Resume training a model that you had trained earlier
    python3 fishSizeEstimation.py train --dataset=/path/to/balloon/dataset --weights=last

    # Train a new model starting from ImageNet weights
    python3 fishSizeEstimation.py train --dataset=/path/to/balloon/dataset --weights=imagenet
